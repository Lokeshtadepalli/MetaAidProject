...
public class Registration {
	...
	@ResponseBody
	@RequestMapping(value = { "/getDist" }, method = { RequestMethod.POST })
	public Response getDist(@RequestBody Integer dist)
	{
		return registerService.getDist(dist);
	}
	@ResponseBody
	@RequestMapping(value = { "/getCit" }, method = { RequestMethod.POST })
	public Response getCit(@RequestBody Integer city)
	{
		return registerService.getCit(city);
	}
}
