...
public class RegisterDao extends BaseDao  {
	...
	public List<Map<String, Object>> getProblems()
	  ...
	  public District getDist(Integer register)
	  {
	    District hospitals = this.sqlSessionTemplate.selectOne("ApplicationRegister.getDist",register);
	    return hospitals;
	  }
	  public College getCit(Integer register)
	  {
	    College hospitals = this.sqlSessionTemplate.selectOne("ApplicationRegister.getCit",register);
	    return hospitals;
	  }
}
