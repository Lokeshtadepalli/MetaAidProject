...
public class RegisterService {
	...
	public Response getDist(Integer register)
	{
		response.setSuccessful(false);
		District singleuserdetails = registerDAO.getDist(register);
		response.setSuccessful(true);
		response.setResponseObject(singleuserdetails);
		return response;
	
	}
	public Response getCit(Integer register)
	{
		response.setSuccessful(false);
		College hospitals= registerDAO.getCit(register);
		response.setSuccessful(true);
		response.setResponseObject(hospitals);
		return response;
	}
